...
use App\Repositories\ResumeRepositorys;
use Illuminate\Support\Facades\Validator;

class ResumeControllers extends Controller
{
    public $dataRepository;
    public function __construct(ResumeRepositorys $dataRepository)
    {
    ...
    public function update(Request $request, $id)
    {
        ...
        $formData = $request->all();
        $validator = Validator::make($formData, [
            'resume' => 'required|resume|mimes:pdf', 
        ]);
        if($validator->fails()){
            return response()->json([
                'success' => false,
