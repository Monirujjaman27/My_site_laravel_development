                            ...
                            <div class="row">
                                <div class="col-md-5">
                                    <div class="">
                                        ...
                                        <p class="mb-0 text-dark"><a href="#"
                                                class=" animated bounceIn btn btn-success rounded-pill py-md-2 py-2 px-3 px-md-3">Start
                                                Project</a></p>
                                    </div>
                                </div>
                                <div class="col-md-5">
                                ...
                                <div class="col-md-2">
                                    <div class="float-right">
                                        <h1 class="number text-dark animated bounceInDown" data-number="{{ $items->counter }}">0</h1>
